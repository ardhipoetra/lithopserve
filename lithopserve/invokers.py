...
from lithopserve.utils import verify_runtime_name, version_str, is_lithops_worker, iterchunks
from lithopserve.constants import LOGGER_LEVEL, LOGS_DIR, SERVERLESS
...
class Invoker:
    ...
    def __init__(self, config, executor_id, internal_storage, compute_handler, job_monitor):
        ...
        prom_enabled = self.config['lithopserve'].get('telemetry', False)
    ...
    def select_runtime(self, job_id, runtime_memory):
        ...
        # Verify python version and lithopserve version
    ...
    if not runtime_meta:
        ...
        with open(ext_docker_file, 'w') as df:
            df.write('\n'.join([
                ...
                'ENV PYTHONPATH=/opt/lithopserve/modules:$PYTHONPATH',
                'COPY . /opt/lithopserve'
            ]))
