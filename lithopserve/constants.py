...
JOBS_PREFIX = "lithopserve.jobs"
TEMP_PREFIX = "lithopserve.jobs/tmp"
LOGS_PREFIX = "lithopserve.logs"
RUNTIMES_PREFIX = "lithopserve.runtimes"
...
SA_INSTALL_DIR = '/opt/lithopserve'
SA_TMP_DIR = '/tmp/lithopserve-root'
...
USER_TEMP_DIR = 'lithopserve-' + os.getenv("USER", "root")
...
CONFIG_DIR = os.path.join(HOME_DIR, '.lithopserve')
CACHE_DIR = os.path.join(CONFIG_DIR, 'cache')
CONFIG_FILE = os.path.join(CONFIG_DIR, 'config')
CONFIG_FILE_GLOBAL = os.path.join("/etc", "lithopserve", "config")
