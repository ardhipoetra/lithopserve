...
from lithopserve.constants import CACHE_DIR, RUNTIMES_PREFIX, JOBS_PREFIX, TEMP_PREFIX
from lithopserve.utils import is_lithops_worker
from lithopserve.storage import utils
from lithopserve.config import extract_storage_config, default_storage_config
...
class Storage:
    ...
    def __init__(self, config=None, backend=None, storage_config=None):
        ...
        :param config: lithopserve configuration dict
        ...
        try:
            module_location = f'lithopserve.storage.backends.{self.backend}'
