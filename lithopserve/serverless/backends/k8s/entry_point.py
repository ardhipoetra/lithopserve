...
from lithopserve.utils import setup_lithops_logger, b64str_to_dict
from lithopserve.worker import function_handler
from lithopserve.worker.utils import get_runtime_metadata
from lithopserve.constants import JOBS_PREFIX
from lithopserve.storage.storage import InternalStorage

from lithopserve.serverless.backends.k8s import config
...
def callback_work_queue(ch, method, properties, body):
    ...
    logger.info("Call from lithopserve received.")
