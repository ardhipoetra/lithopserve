...
from lithopserve.storage.utils import CloudObject, StorageNoSuchKeyError
import lithopserve
from lithopserve.tests import main_util
from lithopserve.tests.util_func.map_reduce_util import my_reduce_function
from lithopserve.tests.util_func.storage_util import my_map_function_storage, \
...
class TestStorage(unittest.TestCase):
    ...
    def test_cloudobject(self):
        ...
        with lithopserve.FunctionExecutor(config=CONFIG) as fexec:
