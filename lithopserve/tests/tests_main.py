...
from lithopserve.config import default_config, extract_storage_config, load_yaml_config
from concurrent.futures import ThreadPoolExecutor
from lithopserve.tests import main_util
from lithopserve.tests.util_func.storage_util import clean_tests
...
def import_test_modules():
    ...
    global TEST_MODULES
    TEST_MODULES = [import_module(module) for module in ["lithopserve.tests." + file[:-3]
                                                         for file in
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="test all Lithops's functionality",
                                     usage='python -m lithopserve.tests.tests_main [-c CONFIG] [-t TESTNAME] ...')
