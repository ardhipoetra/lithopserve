...
import lithopserve  # Mandatory, unless test class is confined to storage testing
from lithopserve.tests import main_util  # required to initialize config variables and other constants below.
...
# ------------------------------------ Incorporate your test function here ---------------------------------------------
    ...
    @unittest.skipIf(subprocess.getoutput("lithopserve --version").split()[2] >= "2.3.4",
    ...
    def test_example_function(self):  # unittest's function naming convention requires functions to be named as demonstrated.
        ...
        from lithopserve.tests.util_func import map_util
