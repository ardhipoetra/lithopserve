...
from lithopserve.worker.utils import peak_memory
...
from lithopserve.wait import wait
from lithopserve.future import ResponseFuture
from lithopserve.utils import WrappedStreamingBody, sizeof_fmt, \
    is_object_processing_function, FuturesList, verify_args
from lithopserve.utils import WrappedStreamingBodyPartition
from lithopserve.util.metrics import PrometheusExporter
from lithopserve.storage.utils import create_output_key
...
class JobRunner:
    ...
    def __init__(self, job, jobrunner_conn, internal_storage):
        ...
        prom_enabled = self.lithops_config['lithopserve'].get('telemetry')
    ...
    def run(self):
        ...
        try:
            ...
            if self.job.config['lithopserve'].get('runtime_include_function'):
