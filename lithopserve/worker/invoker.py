...
from lithopserve.config import extract_serverless_config, extract_storage_config
from lithopserve.invokers import FaaSInvoker
...
def function_invoker(job_payload):
    ...
    monitoring_backend = config['lithopserve']['monitoring'].lower()
