...
from lithopserve.constants import LITHOPS_TEMP_DIR, SA_LOG_FILE, JOBS_DIR, \
    SA_SERVICE_PORT, SA_CONFIG_FILE, SA_DATA_FILE
from lithopserve.localhost import LocalhostHandler
from lithopserve.utils import verify_runtime_name, setup_lithops_logger
...
logger = logging.getLogger('lithopserve.standalone.worker')
