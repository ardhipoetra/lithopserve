...
from lithops_inference.config import extract_serverless_config, extract_storage_config
from lithops_inference.invokers import FaaSInvoker
...
def function_invoker(job_payload):
    ...
    monitoring_backend = config['lithops_inference']['monitoring'].lower()
