...
from lithops_inference.worker.jobrunner import JobRunner
from lithops_inference.worker.utils import LogStream, custom_redirection, \
    get_function_and_modules, get_function_data
from lithops_inference.constants import JOBS_PREFIX, LITHOPS_TEMP_DIR, MODULES_DIR
from lithops_inference.utils import setup_lithops_logger, is_unix_system
from lithops_inference.worker.status import create_call_status
from lithops_inference.worker.utils import SystemMonitor
...
def prepare_and_run_task(task):
    ...
    storage_backend = task.config['lithops_inference']['storage']
