...
from lithops_inference.serverless.included_function.function import default_function
from lithops_inference.worker.utils import peak_memory
...
from lithops_inference.wait import wait
from lithops_inference.future import ResponseFuture
from lithops_inference.utils import WrappedStreamingBody, sizeof_fmt, \
    is_object_processing_function, FuturesList, verify_args
from lithops_inference.utils import WrappedStreamingBodyPartition
from lithops_inference.util.metrics import PrometheusExporter
from lithops_inference.storage.utils import create_output_key
...
class JobRunner:
    ...
    def __init__(self, job, jobrunner_conn, internal_storage):
        ...
        prom_enabled = self.lithops_config['lithops_inference'].get('telemetry')
    ...
    def run(self):
        ...
        try:
            ...
            if self.job.config['lithops_inference'].get('runtime_include_function'):
