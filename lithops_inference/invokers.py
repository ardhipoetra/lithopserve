...
from lithops_inference.config import extract_storage_config
from lithops_inference.version import __version__
from lithops_inference.utils import verify_runtime_name, version_str, is_lithops_worker, iterchunks
from lithops_inference.constants import LOGGER_LEVEL, LOGS_DIR, SERVERLESS
from lithops_inference.util.metrics import PrometheusExporter
...
class Invoker:
    ...
    def __init__(self, config, executor_id, internal_storage, compute_handler, job_monitor):
        ...
        prom_enabled = self.config['lithops_inference'].get('telemetry', False)
    ...
    def select_runtime(self, job_id, runtime_memory):
        ...
        # Verify python version and lithops_inference version
    ...
    if not runtime_meta:
        ...
        with open(ext_docker_file, 'w') as df:
            df.write('\n'.join([
                ...
                'ENV PYTHONPATH=/opt/lithops_inference/modules:$PYTHONPATH',
                'COPY . /opt/lithops_inference'
            ]))
