...
from lithops_inference.constants import CACHE_DIR, RUNTIMES_PREFIX, JOBS_PREFIX, TEMP_PREFIX
from lithops_inference.utils import is_lithops_worker
from lithops_inference.storage import utils
from lithops_inference.config import extract_storage_config, default_storage_config
...
class Storage:
    ...
    def __init__(self, config=None, backend=None, storage_config=None):
        ...
        :param config: lithops_inference configuration dict
        ...
        try:
            module_location = f'lithops_inference.storage.backends.{self.backend}'
