...
from lithops_inference.libs import imp
from lithops_inference.utils import bytes_to_b64str
from lithops_inference.libs.multyvac.module_dependency import ModuleDependencyAnalyzer
...
class SerializeIndependent:
    ...
    def __init__(self, preinstalls):
        ...
        self.preinstalled_modules.append(['lithops_inference', True])
