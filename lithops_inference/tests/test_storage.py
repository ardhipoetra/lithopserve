...
from lithops_inference.storage.utils import CloudObject, StorageNoSuchKeyError
import lithops_inference
from lithops_inference.tests import main_util
from lithops_inference.tests.util_func.map_reduce_util import my_reduce_function
from lithops_inference.tests.util_func.storage_util import my_map_function_storage, \
...
class TestStorage(unittest.TestCase):
    ...
    def test_cloudobject(self):
        ...
        with lithops_inference.FunctionExecutor(config=CONFIG) as fexec:
