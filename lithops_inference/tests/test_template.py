...
import lithops_inference  # Mandatory, unless test class is confined to storage testing
from lithops_inference.tests import main_util  # required to initialize config variables and other constants below.
...
# ------------------------------------ Incorporate your test function here ---------------------------------------------
    ...
    @unittest.skipIf(subprocess.getoutput("lithops_inference --version").split()[2] >= "2.3.4",
    ...
    def test_example_function(self):  # unittest's function naming convention requires functions to be named as demonstrated.
        ...
        from lithops_inference.tests.util_func import map_util
