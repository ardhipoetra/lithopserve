...
from lithops_inference.tests.util_func.map_util import simple_map_function, hello_world, lithops_inside_lithops_map_function, \
...
class TestMap(unittest.TestCase):
    ...
    def test_map(self):
        ...
        fexec = lithops_inference.FunctionExecutor(config=CONFIG, max_workers=1)
        fexec.map(simple_map_function, iterdata)
        result = fexec.get_result()
        self.assertEqual(result, [2, 4, 6, 8])
