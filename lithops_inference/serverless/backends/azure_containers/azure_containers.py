...
from lithops_inference.storage.utils import StorageNoSuchKeyError
...
class AzureContainerAppBackend:
    ...
    def _format_containerapp_name(self, runtime_name, runtime_memory, version=__version__):
        ...
        return f'lithops_inference-worker-{version.replace(".", "")}-{name_hash}'[:31]
    ...
    def _get_default_runtime_image_name(self):
        ...
        return utils.get_default_container_name(
            self.name, self.ac_config, 'lithops_inference-azurecontainers-default'
        )
    ...
    def _create_app(self, runtime_name, memory, timeout):
        ...
        ca_temaplate['tags']['type'] = 'lithops_inference-runtime'
    ...
    def list_runtimes(self, runtime_name='all'):
        ...
        for containerapp in response:
            if containerapp['Tags'] and 'type' in containerapp['Tags'] \
               and containerapp['Tags']['type'] == 'lithops_inference-runtime':
