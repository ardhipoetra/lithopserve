...
from lithops_inference.utils import setup_lithops_logger, b64str_to_dict
from lithops_inference.worker import function_handler
from lithops_inference.worker.utils import get_runtime_metadata
from lithops_inference.constants import JOBS_PREFIX
from lithops_inference.storage.storage import InternalStorage

from lithops_inference.serverless.backends.k8s import config

logger = logging.getLogger('lithops_inference.worker')
...
def callback_work_queue(ch, method, properties, body):
    ...
    logger.info("Call from lithops_inference received.")
