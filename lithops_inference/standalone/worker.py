...
from lithops_inference.constants import LITHOPS_TEMP_DIR, SA_LOG_FILE, JOBS_DIR, \
    SA_SERVICE_PORT, SA_CONFIG_FILE, SA_DATA_FILE
from lithops_inference.localhost import LocalhostHandler
from lithops_inference.utils import verify_runtime_name, setup_lithops_logger
...
logger = logging.getLogger('lithops_inference.standalone.worker')
