...
JOBS_PREFIX = "lithops_inference.jobs"
TEMP_PREFIX = "lithops_inference.jobs/tmp"
LOGS_PREFIX = "lithops_inference.logs"
RUNTIMES_PREFIX = "lithops_inference.runtimes"
...
SA_INSTALL_DIR = '/opt/lithops_inference'
SA_TMP_DIR = '/tmp/lithops_inference-root'
...
USER_TEMP_DIR = 'lithops_inference-' + os.getenv("USER", "root")
...
CONFIG_DIR = os.path.join(HOME_DIR, '.lithops_inference')
CACHE_DIR = os.path.join(CONFIG_DIR, 'cache')
CONFIG_FILE = os.path.join(CONFIG_DIR, 'config')
CONFIG_FILE_GLOBAL = os.path.join("/etc", "lithops_inference", "config")
