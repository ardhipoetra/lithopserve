...
from lithops_serve.multiprocessing import Pool, cpu_count
from lithops_serve.constants import LITHOPS_TEMP_DIR
...
def register_lithops():
    """ Register Lithops Backend to be called with parallel_backend("lithops_serve"). """
    register_parallel_backend("lithops_serve", LithopsBackend)
...
class LithopsBackend(MultiprocessingBackend):
    ...
    def configure(
        ...
        **memmappingpool_args
        ...
        lithops_serve.multiprocessing.pool
        """
        self.prefer = prefer
