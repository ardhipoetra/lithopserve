...
DEFAULT_GROUP = "batch"
DEFAULT_VERSION = "v1"
MASTER_NAME = "lithops_serve-master"
MASTER_PORT = 8080
...
kind: Job
metadata:
  name: lithops_serve-worker-name
  namespace: default
  labels:
    type: lithops_serve-worker
    version: lithops_vX.X.X
    user: lithops_serve-user
spec:
