...
from lithops_serve.utils import setup_lithops_logger, b64str_to_dict
from lithops_serve.worker import function_handler
from lithops_serve.worker.utils import get_runtime_metadata
from lithops_serve.constants import JOBS_PREFIX
from lithops_serve.storage.storage import InternalStorage

from lithops_serve.serverless.backends.k8s import config

logger = logging.getLogger('lithops_serve.worker')
...
def callback_work_queue(ch, method, properties, body):
    ...
    logger.info("Call from lithops_serve received.")
