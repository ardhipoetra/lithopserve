...
class OracleCloudFunctionsBackend:
    ...
    def _format_function_name(self, runtime_name, runtime_memory, version=__version__):
        ...
        return f'lithops_serve-worker-{runtime_name.split("/")[-1]}-v{version}-{name_hash}'
    ...
    def _get_default_runtime_image_name(self):
        ...
        return self._format_image_name(f'lithops_serve-default-runtime-v{py_version}')
    ...
    def deploy_runtime(self, runtime_name, memory, timeout):
        ...
        function_name = self._format_function_name(image_name, memory)
        function_tags = {"type": "lithops_serve-runtime", "lithops_version": __version__}
    ...
    def list_runtimes(self, runtime_name='all'):
        ...
        for function in functions:
            if function.display_name.startswith('lithops_serve-worker'):
                memory = function.memory_in_mbs
                image_name = function.image
