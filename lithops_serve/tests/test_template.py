...
import lithops_serve  # Mandatory, unless test class is confined to storage testing
from lithops_serve.tests import main_util  # required to initialize config variables and other constants below.
...
# ------------------------------------ Incorporate your test function here ---------------------------------------------
    ...
    @unittest.skipIf(subprocess.getoutput("lithops_serve --version").split()[2] >= "2.3.4",
    ...
    def test_example_function(self):  # unittest's function naming convention requires functions to be named as demonstrated.
        ...
        from lithops_serve.tests.util_func import map_util
