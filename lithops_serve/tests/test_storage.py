...
from lithops_serve.storage.utils import CloudObject, StorageNoSuchKeyError
import lithops_serve
from lithops_serve.tests import main_util
from lithops_serve.tests.util_func.map_reduce_util import my_reduce_function
from lithops_serve.tests.util_func.storage_util import my_map_function_storage, \
...
class TestStorage(unittest.TestCase):
    ...
    def test_cloudobject(self):
        ...
        with lithops_serve.FunctionExecutor(config=CONFIG) as fexec:
