...
from lithops_serve.config import default_config, extract_storage_config, load_yaml_config
from concurrent.futures import ThreadPoolExecutor
from lithops_serve.tests import main_util
from lithops_serve.tests.util_func.storage_util import clean_tests
from lithops_serve.utils import setup_lithops_logger
...
def import_test_modules():
    ...
    global TEST_MODULES
    TEST_MODULES = [import_module(module) for module in ["lithops_serve.tests." + file[:-3]
                                                         for file in
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="test all Lithops's functionality",
                                     usage='python -m lithops_serve.tests.tests_main [-c CONFIG] [-t TESTNAME] ...')
