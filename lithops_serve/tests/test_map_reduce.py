...
from lithops_serve.tests.util_func.map_reduce_util import simple_reduce_function, my_reduce_function
from lithops_serve.tests.util_func.map_util import simple_map_function, my_map_function_obj, my_map_function_url
from lithops_serve.tests.util_func.storage_util import list_dataset_keys, get_dataset_key_size
...
class TestMapReduce(unittest.TestCase):
    ...
    def test_map_reduce(self):
        ...
        fexec = lithops_serve.FunctionExecutor(config=CONFIG)
