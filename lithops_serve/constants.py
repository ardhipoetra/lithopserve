...
JOBS_PREFIX = "lithops_serve.jobs"
TEMP_PREFIX = "lithops_serve.jobs/tmp"
LOGS_PREFIX = "lithops_serve.logs"
RUNTIMES_PREFIX = "lithops_serve.runtimes"
...
SA_INSTALL_DIR = '/opt/lithops_serve'
SA_TMP_DIR = '/tmp/lithops_serve-root'
...
USER_TEMP_DIR = 'lithops_serve-' + os.getenv("USER", "root")
...
CONFIG_DIR = os.path.join(HOME_DIR, '.lithops_serve')
CACHE_DIR = os.path.join(CONFIG_DIR, 'cache')
CONFIG_FILE = os.path.join(CONFIG_DIR, 'config')
CONFIG_FILE_GLOBAL = os.path.join("/etc", "lithops_serve", "config")
