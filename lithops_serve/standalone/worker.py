...
from lithops_serve.constants import LITHOPS_TEMP_DIR, SA_LOG_FILE, JOBS_DIR, \
    SA_SERVICE_PORT, SA_CONFIG_FILE, SA_DATA_FILE
from lithops_serve.localhost import LocalhostHandler
from lithops_serve.utils import verify_runtime_name, setup_lithops_logger
...
logger = logging.getLogger('lithops_serve.standalone.worker')
