...
from lithops_serve.config import extract_serverless_config, extract_storage_config
from lithops_serve.invokers import FaaSInvoker
...
def function_invoker(job_payload):
    ...
    monitoring_backend = config['lithops_serve']['monitoring'].lower()
