...
from lithops_serve.serverless.included_function.function import default_function
from lithops_serve.worker.utils import peak_memory
...
from lithops_serve.wait import wait
from lithops_serve.future import ResponseFuture
from lithops_serve.utils import WrappedStreamingBody, sizeof_fmt, \
    is_object_processing_function, FuturesList, verify_args
from lithops_serve.utils import WrappedStreamingBodyPartition
from lithops_serve.util.metrics import PrometheusExporter
from lithops_serve.storage.utils import create_output_key
...
class JobRunner:
    ...
    def __init__(self, job, jobrunner_conn, internal_storage):
        ...
        prom_enabled = self.lithops_config['lithops_serve'].get('telemetry')
    ...
    def run(self):
        ...
        try:
            ...
            if self.job.config['lithops_serve'].get('runtime_include_function'):
