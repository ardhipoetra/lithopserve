...
from lithops_serve.worker.jobrunner import JobRunner
from lithops_serve.worker.utils import LogStream, custom_redirection, \
    get_function_and_modules, get_function_data
from lithops_serve.constants import JOBS_PREFIX, LITHOPS_TEMP_DIR, MODULES_DIR
from lithops_serve.utils import setup_lithops_logger, is_unix_system
from lithops_serve.worker.status import create_call_status
from lithops_serve.worker.utils import SystemMonitor
...
def prepare_and_run_task(task):
    ...
    storage_backend = task.config['lithops_serve']['storage']
