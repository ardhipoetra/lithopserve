...
from lithops_serve.libs import imp
from lithops_serve.utils import bytes_to_b64str
from lithops_serve.libs.multyvac.module_dependency import ModuleDependencyAnalyzer
...
class SerializeIndependent:
    ...
    def __init__(self, preinstalls):
        ...
        self.preinstalled_modules.append(['lithops_serve', True])
