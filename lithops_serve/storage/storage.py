...
from lithops_serve.constants import CACHE_DIR, RUNTIMES_PREFIX, JOBS_PREFIX, TEMP_PREFIX
from lithops_serve.utils import is_lithops_worker
from lithops_serve.storage import utils
from lithops_serve.config import extract_storage_config, default_storage_config
...
class Storage:
    ...
    def __init__(self, config=None, backend=None, storage_config=None):
        ...
        :param config: lithops_serve configuration dict
        ...
        try:
            module_location = f'lithops_serve.storage.backends.{self.backend}'
